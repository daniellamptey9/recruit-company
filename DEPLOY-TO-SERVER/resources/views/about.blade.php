...
@section('content')
      ...
      <div class="auto-container">
        <div class="images-box">
          <div class="row">
            ...
            <div class="column col-lg-3 col-md-6 col-sm-6">
              <figure class="image"><img src="{{ asset('assets/images/resource/about-img-2.jpg') }}" alt=""></figure>
              <figure class="image"><img src="{{ asset('assets/images/resource/about-img-3.jpg') }}" alt=""></figure>
            </div>
            <div class="column col-lg-3 col-md-6 col-sm-6">
              <figure class="image"><img src="{{ asset('assets/images/resource/about-img-4.jpg') }}" alt=""></figure>
              <figure class="image"><img src="{{ asset('assets/images/resource/about-img-5.jpg') }}" alt=""></figure>
            </div>
            <div class="column col-lg-3 col-md-6 col-sm-6">
              <figure class="image"><img src="{{ asset('assets/images/resource/about-img-6.jpg') }}" alt=""></figure>
            </div>
          </div>
        </div>
    ...
    <section class="testimonial-section-two">
      <div class="container-fluid">
        <div class="testimonial-left"><img src="{{ asset('assets/images/resource/testimonial-left.png') }}" alt=""></div>
        <div class="testimonial-right"><img src="{{ asset('assets/images/resource/testimonial-right.png') }}" alt=""></div>
        <!-- Sec Title -->
        ...
        <div class="carousel-outer">
          ...
          <div class="testimonial-carousel owl-carousel owl-theme">
            ...
            <div class="testimonial-block-two">
              <div class="inner-box">
                <div class="thumb"><img src="{{ asset('assets/images/resource/testi-thumb-1.png') }}" alt=""></div>
