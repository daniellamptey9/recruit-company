{{-- Superio candidate change password (dashboard-change-password.html) --}}
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
  <title>Superio | Change Password</title>
    ...
    <section class="user-dashboard">
      <div class="dashboard-outer">
        <div class="upper-title-box">
          ...
          <div class="text">Update your password for security</div>
        </div>
        ...
        <div class="ls-widget">
          ...
          <div class="widget-content">
            <form class="default-form" method="POST" action="{{ route('candidate.change-password.update') }}">
              @csrf
              <div class="row">
                <!-- Input -->
