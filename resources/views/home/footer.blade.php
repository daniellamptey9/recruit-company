<footer class="main-footer style-four">
        ...
        <div class="auto-container">
          <div class="outer-box">
            @php 
              ...
              $siteOwner = \App\Models\User::where('role','admin')->first();
            @endphp
            <div class="copyright-text">© {{ date('Y') }} <a href="{{ route('home') }}">{{ $company->name ?? ($siteOwner->name ?? config('app.name', 'Mine Care Recruitment')) }}</a>. All Rights Reserved.</div>
      ...
      <div class="scroll-to-top scroll-to-target style-two" data-target="html"><span class="fa fa-angle-up"></span></div>
    </footer>